    ...
    return (
        <div style={{ display: "flex", flexDirection: "row", width: "100%" }}>
            <div style={{ display: "flex", flexDirection: "column", width: "100%", padding: "24px"}}>
                ...
                <p className="work-paragraph" style={{ fontSize: "14px", margin: "8px 0"}}>Taking care of a newborn child is a lot of work. Caregivers need to track eating and sleeping metrics, doctor appointments, developmental milestones, and more. BabySteps is a comprehensive newborn caretaking app that helps all caregivers stay updated and organized with their child's development. BabySteps also includes a social component where caregivers can store and share photos and journal entries documenting their child's development. By allowing caregivers to track and share a baby's development metrics and milestones, BabySteps alleviates some of the cognitive load of caring for a baby. It also helps caregivers include the child's village in their first year of life.</p>
